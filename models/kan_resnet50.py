"""KAN-ResNet50 wrapper for Conv2d replacement studies (stage-gated 3×3 and 1×1).
...
from .kan_resnet_common import Bottleneck, KANResNetLaterStages
...
def _resolve_pretrained_path(pretrained_path: str | None) -> str | None:
    ...
    return os.getenv("KAN_RESNET50_PRETRAINED_PATH") or os.getenv("KAN_PRETRAINED_PATH")
    ...
    if pretrained:
        ...
        if not resolved:
            raise ValueError(
                ...
                "`KAN_RESNET50_PRETRAINED_PATH` / `KAN_PRETRAINED_PATH`."
            )
